...
<head>
	...
	<?php if(Auth::check() && $u->permission == 2): ?>
	<script src="<?php echo e(asset('assets/js/admin_shop.js')); ?>"></script>
	<?php else: ?>
		...
		<div class="row">
			...
			" style="background-color: transparent; height: 350px; padding: 0;">
				...
				<div id="shop-right-panel" class="col-xs-3 col-md-2 my-font-regular">
					...
					<button type="button" class="myButton sendOffer" id="btn4"><?php echo $lang['shop']['withdraw_btn']; ?></button>
