...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="card">
                                <div class="stat-widget-one">
									...
									<div class="stat-content dib">
										...
										<div class="stat-digit">$<?php echo e($stats['day']); ?></div>
									</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="stat-widget-one">
									...
									<div class="stat-content dib">
										...
										<div class="stat-digit">$<?php echo e($stats['week']); ?></div>
									</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="stat-widget-one">
									...
									<div class="stat-content dib">
										...
										<div class="stat-digit">$<?php echo e($stats['month']); ?></div>
									</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="stat-widget-one">
									...
									<div class="stat-content dib">
										...
										<div class="stat-digit">$<?php echo e($stats['all']); ?></div>
									</div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="<?php echo e(asset('assets/js/lib/chart-js/chartjs-init.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/js/panel.js')); ?>"></script>
