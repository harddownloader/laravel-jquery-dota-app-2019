                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->dep_minprice_item); ?>" name="dep_minprice_item">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->dep_minprice); ?>" name="dep_minprice">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->with_minprice_item); ?>" name="with_minprice_item">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->with_minprice); ?>" name="with_minprice">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->shop_curs); ?>" name="shop_curs">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->with_lvl); ?>" name="with_lvl">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Наценка (%)</label>
                                                        <input type="number" class="form-control" value="<?php echo e($config->with_percent); ?>" name="with_percent">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->with_max_items); ?>" name="with_max_items">
                                                    </div>
                                                </div>
