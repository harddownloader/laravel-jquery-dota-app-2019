                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->poker_bet_timer); ?>" name="poker_bet_timer">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->poker_raise_timer); ?>" name="poker_raise_timer">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="<?php echo e($config->poker_puttype); ?>" name="poker_puttype">
                                                    </div>
                                                </div>
