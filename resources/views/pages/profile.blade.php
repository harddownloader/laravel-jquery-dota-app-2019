				...
				<div class="tab-content">
						...
						<div class="collection-list">
							...
							<div class="row">
								...
								@foreach($achievements as $key => $achievement)
									...
									<div class="achievement-icon" title="{{ $lang['achievements'][$achievement->name]['desc'] }}">
									...
									@else
									<div class="achievement-icon" title="{{ $lang['achievements'][$achievement->name]['desc'] }}" style="opacity: 0;">
										<img src="/assets/images/prizes/{{ $achievement->img }}.png">
										<h3>{{ $achievement->name }}</h3>
										<p class="achievement-desc"></p>
										<!-- <p class="achievement-price">{{ $lang['achievements'][$achievement->name]['value'] }}<span class="coin noselect"></span></p> -->
					...
					<div role="tabpanel" class="tab-pane" id="trophies">
						<div class="collection-list five-in-row">
							...
							<div>
							@foreach($achievements as $key => $achievement)
								@if($achievement->category == "lvl" && $i < $lvlCount)
									@if($achievement->unlock)
						...
						<div class="row" style="padding-left: 115px; padding-right: 115px;">
							...
							@endphp
							@foreach($achievements as $key => $achievement)
								@if($achievement->category == "lvl" && $i < $lvlCount && $key > 4)
									@if($achievement->unlock)
		...
		<div class="
			...
			<div class="col-sm-6 col-sm-offset-3
				col-xs-10 col-xs-offset-1 hcenter">
					...
					<br>
					<small>You referral code : {{ $u->ref }}</small>
				</div>
