                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Минимальное кол-во символов в сообщении ({{ $config->chat_min_strlen }})</label>
                                                        <input type="number" class="form-control" value="{{ $config->chat_min_strlen }}" name="chat_min_strlen">
                                                    </div>
                                                </div>

                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Максимальное кол-во символов в сообщении ({{ $config->chat_max_strlen }}) (0 - выкл)</label>
                                                        <input type="number" class="form-control" value="{{ $config->chat_max_strlen }}" name="chat_max_strlen">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="chat_double_messages" class="form-control">@for($i = 0; $i < count($messages); $i++){{$messages[$i]->msg}} : {{$messages[$i]->won}}@if($i != count($messages)-1);@endif&#13;@endfor</textarea>
                                                    </div>
                                                </div>
