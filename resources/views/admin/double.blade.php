                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->double_timer }}" name="double_timer">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->double_timetoslider }}" name="double_timetoslider">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->double_timetonewgame }}" name="double_timetonewgame">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->double_minplayers }}" name="double_minplayers">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->double_min_bet }}" name="double_min_bet">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->double_max_bet }}" name="double_max_bet">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->double_candoit }}" name="double_candoit">
                                                    </div>
                                                </div>
