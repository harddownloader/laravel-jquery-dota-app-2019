									...
									<table id="bootstrap-data-table" class="table table-striped table-bordered">
										...
										<tbody>
                                            @foreach($images as $image)
                                                <tr>
                                                    <td><center>{{ $image->id }}</center></td>
                                                    <td><center><img src="{{ $image->url }}" width="40px" style="border-radius : 50%"></center></td>
                                                    <td><center>
                                                        @if($image->type == 0)
                                                            Обычный
                                                        @elseif($image->type == 1)
                                                    ...
                                                    <td><center>{{ $image->multiplier }}</center></td>
                                                    <td>
                                                        <center>
                                                            <a href="/admin/bandit/edit_image/{{ $image->id }}" class="btn btn-info btn-flat btn-addon btn-sm m-l-5 unban_user"><i class="ti-settings"></i>Редактировать</a>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->bandit_min_bet }}" name="bandit_min_bet">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->bandit_max_bet }}" name="bandit_max_bet">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value="{{ $config->bandit_free_spins_chance }}" name="bandit_free_spins_chance">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_free_spins_count }}" name="bandit_free_spins_count">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_winpercent }}" name="bandit_winpercent">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_winpercent2 }}" name="bandit_winpercent2">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_winpercent3 }}" name="bandit_winpercent3">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_winpercent4 }}" name="bandit_winpercent4">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_winpercent5 }}" name="bandit_winpercent5">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_winpercent6 }}" name="bandit_winpercent6">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_winpercent7 }}" name="bandit_winpercent7">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_winpercent8 }}" name="bandit_winpercent8">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_winpercent9 }}" name="bandit_winpercent9">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_quest }}" name="bandit_quest">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $config->bandit_mgame }}" name="bandit_mgame">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Шанс выпадения игры #3 (Башни) [1-100]</label>
                                                        <input type="text" class="form-control" value="{{ $config->bandit_towers }}" name="bandit_towers">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Шанс выпадения Бонусной Игры [1-100]</label>
                                                        <input type="text" class="form-control" value="{{ $config->bandit_bonus }}" name="bandit_bonus">
                                                    </div>
                                                </div>
