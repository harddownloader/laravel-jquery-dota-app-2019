										...
										<tbody>
                                            @foreach($list as $promo)
                                                <tr>
                                                    ...
                                                    <td>{{ $promo->promo }}</td>
                                                    <td>{{ $promo->money }}</td>
                                                    <td>{{ $promo->used }}/{{ $promo->count }}</td>
                                                    <td>
                                                        <a href="/admin/promo/{{ $promo->id }}" class="btn btn-info btn-flat btn-addon btn-sm m-l-5 edit_user"><i class="ti-settings"></i>Редактировать</a>
                                                        <a href="/admin/promo/delete/{{ $promo->id }}" class="btn btn-danger btn-flat btn-addon btn-sm m-l-5 edit_user"><i class="ti-settings"></i>Удалить</a>
                                                    </td>
                                                </tr>
                                            @endforeach
										</tbody>
