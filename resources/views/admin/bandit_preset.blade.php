                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $preset->args[3]->value }}" name="{{ $preset->args[3]->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $preset->args[4]->value }}" name="{{ $preset->args[4]->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $preset->args[5]->value }}" name="{{ $preset->args[5]->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $preset->args[6]->value }}" name="{{ $preset->args[6]->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $preset->args[11]->value }}" name="{{ $preset->args[11]->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $preset->args[12]->value }}" name="{{ $preset->args[12]->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $preset->args[13]->value }}" name="{{ $preset->args[13]->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $preset->args[14]->value }}" name="{{ $preset->args[14]->name }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Шанс выпадения игры #3 (Башни) [1-100]</label>
                                                        <input type="text" class="form-control" value="{{ $preset->args[15]->value }}" name="{{ $preset->args[15]->name }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Шанс выпадения Бонусной Игры [1-100]</label>
                                                        <input type="text" class="form-control" value="{{ $preset->args[16]->value }}" name="{{ $preset->args[16]->name }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
